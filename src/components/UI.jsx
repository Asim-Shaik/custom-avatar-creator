...
const AssetsBox = () => {
  ...
  return (
    <div className="rounded-t-lg bg-gradient-to-br from-black/30 to indigo-900/20 backdrop-blur-sm drop-shadow-md py-6 gap-3 flex flex-col">
      <div className="flex item-center gap-8 pointer-events-auto overflow-x-auto noscrollbar px-6 pb-2 ">
